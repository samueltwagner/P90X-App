...
namespace WorkoutApp.Services
{
    public class WorkoutService
    {
        ...
        public Workout Get(string id) =>
            _workouts.Find<Workout>(workout => workout.WorkoutId == id).FirstOrDefault();
        ...
        public void Update(string id, Workout workoutIn) =>
            _workouts.ReplaceOne(workout => workout.WorkoutId == id, workoutIn);

        public void Remove(Workout workoutIn) =>
            _workouts.DeleteOne(workout => workout.WorkoutId == workoutIn.WorkoutId);

        public void Remove(string id) => 
            _workouts.DeleteOne(workout => workout.WorkoutId == id);
    }
}